<template>
    <div class="ratings" ref="ratings">
        <div class="ratings-content">
            ...
            <div class="split"></div>
            <RatingsView @select="selectRating" @toggle="toggleContent" :ratings="ratings" :selectType="selectType" :onlyContent="onlyContent"></RatingsView>       
...
import RatingsView from '../com/RatingSel.vue'
    ...
    export default{
        ...
        created(){
            ...
            this.$http.get('src/data.json').then((msg)=>{
                ...
                _this.ratings=msg.data.ratings;
                _this.$nextTick(()=>{
